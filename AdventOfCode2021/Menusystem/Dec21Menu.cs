...
{
    class Dec21Menu : ProblemMenu
    {
        private Menu _mainMenu;

        public Dec21Menu(Menu mainMenu)
        {
            _mainMenu = mainMenu;
        }
        ...
        {
            Console.WriteLine("Welcome to december 21th. Make sure that you copy your input into a file called dec21.txt in the debug folder");
        ...
        public override int HandleInput()
        {
            ...
            string[] results = inputHandler.GetInputRows("dec21.txt");
            switch (input)
            {
                case 1:
                    break;
