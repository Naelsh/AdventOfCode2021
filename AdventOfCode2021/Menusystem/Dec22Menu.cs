...
{
    class Dec22Menu : ProblemMenu
    {
        private Menu _mainMenu;

        public Dec22Menu(Menu mainMenu)
        {
            _mainMenu = mainMenu;
        }
        ...
        {
            Console.WriteLine("Welcome to december 22nd. Make sure that you copy your input into a file called dec22.txt in the debug folder");
        ...
        public override int HandleInput()
        {
            ...
            string[] results = inputHandler.GetInputRows("dec22.txt");
            switch (input)
            {
                case 1:
                    break;
