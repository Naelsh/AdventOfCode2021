...
{
    class Dec16Menu : ProblemMenu
    {
        private Menu _mainMenu;

        public Dec16Menu(Menu mainMenu)
        {
            _mainMenu = mainMenu;
        }
        ...
        {
            Console.WriteLine("Welcome to december 16rd. Make sure that you copy your input into a file called dec16.txt in the debug folder");
        ...
        public override int HandleInput()
        {
            ...
            string[] results = inputHandler.GetInputRows("dec16.txt");
            switch (input)
            {
                case 1:
                    break;
