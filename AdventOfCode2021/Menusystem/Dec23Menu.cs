...
{
    class Dec23Menu : ProblemMenu
    {
        private Menu _mainMenu;

        public Dec23Menu(Menu mainMenu)
        {
            _mainMenu = mainMenu;
        }
        ...
        {
            Console.WriteLine("Welcome to december 23rd. Make sure that you copy your input into a file called dec23.txt in the debug folder");
        ...
        public override int HandleInput()
        {
            ...
            string[] results = inputHandler.GetInputRows("dec23.txt");
            switch (input)
            {
                case 1:
                    break;
