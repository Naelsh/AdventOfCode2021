...
{
    class Dec25Menu : ProblemMenu
    {
        private Menu _mainMenu;

        public Dec25Menu(Menu mainMenu)
        {
            _mainMenu = mainMenu;
        }
        ...
        {
            Console.WriteLine("Welcome to december 25rd. Make sure that you copy your input into a file called dec25.txt in the debug folder");
        ...
        public override int HandleInput()
        {
            ...
            string[] results = inputHandler.GetInputRows("dec25.txt");
            switch (input)
            {
                case 1:
                    break;
