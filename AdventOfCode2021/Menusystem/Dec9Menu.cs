...
{
    class Dec9Menu : ProblemMenu
    {
        private Menu _mainMenu;

        public Dec9Menu(Menu mainMenu)
        {
            _mainMenu = mainMenu;
        }
        ...
        {
            Console.WriteLine("Welcome to december 9th. Make sure that you copy your input into a file called dec9.txt in the debug folder");
        ...
        public override int HandleInput()
        {
            ...
            string[] results = inputHandler.GetInputRows("dec9.txt");
            switch (input)
            {
                case 1:
                    break;
