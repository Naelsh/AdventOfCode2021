...
{
    class Dec10Menu : ProblemMenu
    {
        private Menu _mainMenu;

        public Dec10Menu(Menu mainMenu)
        {
            _mainMenu = mainMenu;
        }
        ...
        {
            Console.WriteLine("Welcome to december 10th. Make sure that you copy your input into a file called dec10.txt in the debug folder");
        ...
        public override int HandleInput()
        {
            ...
            string[] results = inputHandler.GetInputRows("dec10.txt");
            switch (input)
            {
                case 1:
                    break;
