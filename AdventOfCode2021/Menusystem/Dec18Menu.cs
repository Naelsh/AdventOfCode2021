...
{
    class Dec18Menu : ProblemMenu
    {
        private Menu _mainMenu;

        public Dec18Menu(Menu mainMenu)
        {
            _mainMenu = mainMenu;
        }
        ...
        {
            Console.WriteLine("Welcome to december 18th. Make sure that you copy your input into a file called dec18.txt in the debug folder");
        ...
        public override int HandleInput()
        {
            ...
            string[] results = inputHandler.GetInputRows("dec18.txt");
            switch (input)
            {
                case 1:
                    break;
