...
{
    class Dec14Menu : ProblemMenu
    {
        private Menu _mainMenu;

        public Dec14Menu(Menu mainMenu)
        {
            _mainMenu = mainMenu;
        }
        ...
        {
            Console.WriteLine("Welcome to december 14th. Make sure that you copy your input into a file called dec14.txt in the debug folder");
        ...
        public override int HandleInput()
        {
            ...
            string[] results = inputHandler.GetInputRows("dec14.txt");
            switch (input)
            {
                case 1:
                    break;
