...
{
    class Dec13Menu : ProblemMenu
    {
        private Menu _mainMenu;

        public Dec13Menu(Menu mainMenu)
        {
            _mainMenu = mainMenu;
        }
        ...
        {
            Console.WriteLine("Welcome to december 13th. Make sure that you copy your input into a file called dec13.txt in the debug folder");
        ...
        public override int HandleInput()
        {
            ...
            string[] results = inputHandler.GetInputRows("dec13.txt");
            switch (input)
            {
                case 1:
                    break;
