...
{
    class Dec15Menu : ProblemMenu
    {
        private Menu _mainMenu;

        public Dec15Menu(Menu mainMenu)
        {
            _mainMenu = mainMenu;
        }
        ...
        {
            Console.WriteLine("Welcome to december 15th. Make sure that you copy your input into a file called dec15.txt in the debug folder");
        ...
        public override int HandleInput()
        {
            ...
            string[] results = inputHandler.GetInputRows("dec15.txt");
            switch (input)
            {
                case 1:
                    break;
