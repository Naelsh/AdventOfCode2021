...
{
    class Dec17Menu : ProblemMenu
    {
        private Menu _mainMenu;

        public Dec17Menu(Menu mainMenu)
        {
            _mainMenu = mainMenu;
        }
        ...
        {
            Console.WriteLine("Welcome to december 17rd. Make sure that you copy your input into a file called dec17.txt in the debug folder");
        ...
        public override int HandleInput()
        {
            ...
            string[] results = inputHandler.GetInputRows("dec17.txt");
            switch (input)
            {
                case 1:
                    break;
