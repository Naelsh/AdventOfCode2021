...
{
    class Dec12Menu : ProblemMenu
    {
        private Menu _mainMenu;

        public Dec12Menu(Menu mainMenu)
        {
            _mainMenu = mainMenu;
        }
        ...
        {
            Console.WriteLine("Welcome to december 12th. Make sure that you copy your input into a file called dec12.txt in the debug folder");
        ...
        public override int HandleInput()
        {
            ...
            string[] results = inputHandler.GetInputRows("dec12.txt");
            switch (input)
            {
                case 1:
                    break;
