...
{
    class Dec11Menu : ProblemMenu
    {
        private Menu _mainMenu;

        public Dec11Menu(Menu mainMenu)
        {
            _mainMenu = mainMenu;
        }
        ...
        {
            Console.WriteLine("Welcome to december 11th. Make sure that you copy your input into a file called dec11.txt in the debug folder");
        ...
        public override int HandleInput()
        {
            ...
            string[] results = inputHandler.GetInputRows("dec11.txt");
            switch (input)
            {
                case 1:
                    break;
