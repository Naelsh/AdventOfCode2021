...
{
    class Dec24Menu : ProblemMenu
    {
        private Menu _mainMenu;

        public Dec24Menu(Menu mainMenu)
        {
            _mainMenu = mainMenu;
        }
        ...
        {
            Console.WriteLine("Welcome to december 24th. Make sure that you copy your input into a file called dec24.txt in the debug folder");
        ...
        public override int HandleInput()
        {
            ...
            string[] results = inputHandler.GetInputRows("dec24.txt");
            switch (input)
            {
                case 1:
                    break;
